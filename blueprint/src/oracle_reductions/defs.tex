...
\begin{definition}[Protocol Specification Components]
    ...
    \end{itemize}
    \lean{ProtocolSpec.dir}
    \lean{ProtocolSpec.Type}
    \lean{ProtocolSpec.MessageIdx}
    \lean{ProtocolSpec.ChallengeIdx}
    \lean{ProtocolSpec.Message}
    \lean{ProtocolSpec.Challenge}
...
\begin{definition}[Prover Execution to Round]
    ...
    \lean{Prover.runToRound}
    \lean{Prover.processRound}
