...
| `T4.13` | MCA from τ-subspace-design | missing (deferred — needs `IsSubspaceDesign` predicate) | none | `CodingTheory.subspaceDesign_mca` (external) | GG25 Cor 4.9. |
| `T4.14` | Folded RS MCA up to capacity | missing (deferred — needs FRS code) | none | `CodingTheory.frs_mca_capacity` (external) | GG25 Cor 4.10. |
