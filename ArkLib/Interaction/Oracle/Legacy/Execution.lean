...
/-!
# Legacy OracleDecoration Execution

Quarantined execution semantics for the transitional `OracleDecoration` surface.
Prefer `ArkLib.Interaction.Oracle.Execution` for native `Oracle.Spec` execution.
-/
