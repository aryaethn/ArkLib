...
/-!
# Interaction-Native FRI: Native Query Round

This module formalizes the executable FRI query checks on the native
...
/-- Native reduction for the FRI query phase. It samples a batch of base-domain
